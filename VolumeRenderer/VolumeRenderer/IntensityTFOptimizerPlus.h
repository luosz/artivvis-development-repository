...
#ifndef IntensityTFOptimizerPlus_h
#define IntensityTFOptimizerPlus_h

#include "IntensityTFOptimizer.h"
class IntensityTFOptimizerPlus : public IntensityTFOptimizer
{
public:

	IntensityTFOptimizerPlus(VolumeDataset &volume_, int numIntensities_, glm::vec4 *colors_, float *intensities_) : IntensityTFOptimizer(volume_, numIntensities_, colors_, intensities_)
	{

	}

	//virtual ~IntensityTFOptimizerPlus()
	//{
	//}
...
#endif // IntensityTFOptimizerPlus_h
