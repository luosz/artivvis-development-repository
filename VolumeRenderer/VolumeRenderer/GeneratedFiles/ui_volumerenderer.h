...
public:
    ...
    void setupUi(QMainWindow *VolumeRendererClass)
    {
        ...
        tfIntensity14 = new QSlider(tab_6);
        tfIntensity14->setObjectName(QStringLiteral("tfIntensity14"));
        tfIntensity14->setGeometry(QRect(290, 130, 91, 19));
        tfIntensity14->setOrientation(Qt::Horizontal);
        tfIntensity14->setTickPosition(QSlider::TicksAbove);
        tfIntensity15 = new QSlider(tab_6);
        tfIntensity15->setObjectName(QStringLiteral("tfIntensity15"));
        tfIntensity15->setGeometry(QRect(290, 170, 91, 19));
        ...
        tfIntLabel14 = new QLabel(tab_6);
        tfIntLabel14->setObjectName(QStringLiteral("tfIntLabel14"));
        tfIntLabel14->setGeometry(QRect(390, 130, 31, 16));
        tfIntLabel15 = new QLabel(tab_6);
        tfIntLabel15->setObjectName(QStringLiteral("tfIntLabel15"));
        tfIntLabel15->setGeometry(QRect(390, 170, 31, 16));
    ...
    void retranslateUi(QMainWindow *VolumeRendererClass)
    {
        ...
        tfIntLabel14->setText(QApplication::translate("VolumeRendererClass", "TextLabel", 0));
